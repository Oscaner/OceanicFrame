...
class m181130_061401_sys_auth_3_assignment extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        /* 外键约束设置 */
        $this->addForeignKey('fk_sys_auth_2_item_3496_00','{{%sys_auth_3_assignment}}', 'item_name', '{{%sys_auth_2_item}}', 'name', 'CASCADE', 'CASCADE' );
