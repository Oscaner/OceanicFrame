...
class m181230_121931_sys_auth_4_item_child extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        /* 外键约束设置 */
        $this->addForeignKey('fk_sys_auth_2_item_9431_00','{{%sys_auth_4_item_child}}', 'child', '{{%sys_auth_2_item}}', 'name', 'CASCADE', 'CASCADE' );
        $this->addForeignKey('fk_sys_auth_2_item_9431_01','{{%sys_auth_4_item_child}}', 'parent', '{{%sys_auth_2_item}}', 'name', 'CASCADE', 'CASCADE' );
