...
class m181230_121931_sys_config extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->insert('{{%sys_config}}',['id'=>'7','title'=>'上传文件类型','name'=>'WEB_FILE_TYPE','type'=>'text','extra'=>'','describe'=>'以半角 | 隔开，如：png|gif|jpg|jpeg|zip|rar','value'=>'png|gif|jpg|jpeg|zip|rar','pid'=>'2','sort'=>'6','status'=>'1','level'=>'3','append'=>'1541415162','updated'=>'1546171974']);
        $this->insert('{{%sys_config}}',['id'=>'9','title'=>'META关键字','name'=>'WEB_META_KEY','type'=>'textarea','extra'=>'','describe'=>'多个关键词用半角 , 号分割','value'=>'OceanicFrame,oceanickang,yii,php','pid'=>'2','sort'=>'7','status'=>'1','level'=>'3','append'=>'1541415337','updated'=>'1546171976']);
        $this->insert('{{%sys_config}}',['id'=>'10','title'=>'META描述','name'=>'WEB_META_DESCRIBE','type'=>'textarea','extra'=>'','describe'=>'','value'=>'OceanicFrame 是由 OceanicKang 开发的一款应用开发引擎','pid'=>'2','sort'=>'8','status'=>'1','level'=>'3','append'=>'1541415397','updated'=>'1546171978']);
        $this->insert('{{%sys_config}}',['id'=>'11','title'=>'版权信息','name'=>'WEB_COPY_RIGHT','type'=>'textarea','extra'=>'','describe'=>'','value'=>'&copy 2018 <a href=\"https://www.oceanickang.com\" target=\"_blank\">OceanicKang</a> 版权所有','pid'=>'2','sort'=>'9','status'=>'1','level'=>'3','append'=>'1541415445','updated'=>'1546171980']);
        ...
        $this->insert('{{%sys_config}}',['id'=>'25','title'=>'默认头像','name'=>'WEB_DEFAULT_AVATAR','type'=>'image','extra'=>'','describe'=>'','value'=>'/resources/common/img/head_img.png','pid'=>'2','sort'=>'10','status'=>'1','level'=>'3','append'=>'1544407971','updated'=>'1546171982']);
        $this->insert('{{%sys_config}}',['id'=>'26','title'=>'保留原名','name'=>'UPLOAD_IMAGES_ORIGIN_NAME','type'=>'statusRadio','extra'=>'','describe'=>'是否保留上传图片原名（建议：关闭）','value'=>'0','pid'=>'23','sort'=>'1','status'=>'1','level'=>'3','append'=>'1544681814','updated'=>'1546168187']);
        ...
        $this->insert('{{%sys_config}}',['id'=>'28','title'=>'完整图片路径','name'=>'UPLOAD_IMAGES_FULL_PATH','type'=>'statusRadio','extra'=>'','describe'=>'是否开启返回完整的图片路径（建议：开启）','value'=>'1','pid'=>'23','sort'=>'2','status'=>'1','level'=>'3','append'=>'1544683389','updated'=>'1546168201']);
        ...
        $this->insert('{{%sys_config}}',['id'=>'30','title'=>'图片主目录','name'=>'UPLOAD_IMAGES_MAIN_PATH','type'=>'text','extra'=>'','describe'=>'图片主目录（建议：网站上线后不要随意更改）','value'=>'images/','pid'=>'23','sort'=>'6','status'=>'1','level'=>'3','append'=>'1544683792','updated'=>'1546168353']);
        $this->insert('{{%sys_config}}',['id'=>'31','title'=>'图片子目录','name'=>'UPLOAD_IMAGES_SUB_PATH','type'=>'text','extra'=>'','describe'=>'图片子目录（Y:年，m:月，d:日）（建议：网站上线后不要随意更改）','value'=>'Y/m/d','pid'=>'23','sort'=>'8','status'=>'1','level'=>'3','append'=>'1544683851','updated'=>'1546168405']);
        $this->insert('{{%sys_config}}',['id'=>'32','title'=>'图片前缀','name'=>'UPLOAD_IMAGES_PREFIX','type'=>'text','extra'=>'','describe'=>'（建议：网站上线后不要随意更改）','value'=>'image_','pid'=>'23','sort'=>'9','status'=>'1','level'=>'3','append'=>'1544683883','updated'=>'1546168433']);
        $this->insert('{{%sys_config}}',['id'=>'33','title'=>'图片压缩','name'=>'UPLOAD_IMAGES_COMPRESS','type'=>'statusRadio','extra'=>'','describe'=>'是否开启图片压缩','value'=>'0','pid'=>'23','sort'=>'14','status'=>'1','level'=>'3','append'=>'1544683925','updated'=>'1546167757']);
...
1024*1024*1=>30,
1024*1024*2=>20,
1024*1024*1024=>10','pid'=>'23','sort'=>'15','status'=>'1','level'=>'3','append'=>'1544684238','updated'=>'1546167759']);
        $this->insert('{{%sys_config}}',['id'=>'35','title'=>'缩略图目录','name'=>'UPLOAD_IMAGES_THUMB_PATH','type'=>'text','extra'=>'','describe'=>'缩略图主目录（建议：网站上线后不要随意更改）','value'=>'thumb/','pid'=>'23','sort'=>'7','status'=>'1','level'=>'3','append'=>'1545185246','updated'=>'1546168365']);
        $this->insert('{{%sys_config}}',['id'=>'36','title'=>'图片水印','name'=>'UPLOAD_IMAGES_WATERMARK','type'=>'statusRadio','extra'=>'','describe'=>'是否开启图片水印','value'=>'1','pid'=>'23','sort'=>'11','status'=>'1','level'=>'3','append'=>'1546151119','updated'=>'1546167751']);
        $this->insert('{{%sys_config}}',['id'=>'37','title'=>'水印位置','name'=>'UPLOAD_IMAGES_WATERMARK_LOCAL','type'=>'radioList','extra'=>'1=>左上,2=>中上,3=>右上,4=>左中,5=>正中,6=>右中,7=>左下,8=>中下,9=>右下','describe'=>'','value'=>'9','pid'=>'23','sort'=>'12','status'=>'1','level'=>'3','append'=>'1546151299','updated'=>'1546167753']);
        $this->insert('{{%sys_config}}',['id'=>'38','title'=>'水印图片','name'=>'UPLOAD_IMAGES_WATERMARK_IMG','type'=>'image','extra'=>'','describe'=>'','value'=>'','pid'=>'23','sort'=>'13','status'=>'1','level'=>'3','append'=>'1546153267','updated'=>'1546167755']);
        $this->insert('{{%sys_config}}',['id'=>'39','title'=>'缩略图大小','name'=>'UPLOAD_IMAGES_THUMB_SIZE','type'=>'text','extra'=>'','describe'=>'长*宽|长*宽|长*宽（单位：px）','value'=>'100*100|150*150|200*200','pid'=>'23','sort'=>'10','status'=>'1','level'=>'3','append'=>'1546167691','updated'=>'1546169465']);
