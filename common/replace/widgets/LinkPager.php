...
class LinkPager extends Widget
{
     ...
     */
    public $options = ['tag' => 'div', 'class' => 'layui-box layui-laypage layui-laypage-molv'];
    /**
     ...
     */
    public $firstPageCssClass = 'layui-laypage-first';
    /**
     * @var string the CSS class for the "last" page button.
     */
    public $lastPageCssClass = 'layui-laypage-last';
    /**
     ...
     */
    public $activePageCssClass = 'of-laypage-active';
    /**
     ...
     * @since 2.0.11
     */
    public $disabledListItemSubTagOptions = ['tag' => 'a', 'class' => 'layui-disabled'];
    /**
    ...
    protected function renderPageButton($label, $page, $class, $disabled, $active)
    {
        ...
        if ($active) {
            $linkWrapTag = 'span';
            $activeLinkOptions = $this -> activeLinkOptions;
            $activeLinkOptions['class'] .= ' layui-laypage-em';
            $options = ['class' => 'layui-laypage-curr'];

            return Html::tag($linkWrapTag, Html::tag('em', '', $activeLinkOptions) . Html::tag('em', $label), $options);
        }
